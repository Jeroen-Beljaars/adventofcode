...
def handle_instructions(instructions):
    direction_values = {NORTH: 0, EAST: 0, SOUTH: 0, WEST: 0}
    current_degree = 0
    ...
    return abs(direction_values[EAST] - direction_values[WEST]) + abs(direction_values[NORTH] - direction_values[SOUTH])
