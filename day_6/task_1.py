...
plane (your puzzle input). Each group's answers are separated by a blank line, and within each group,
...
def get_answer_count(answers):
    ...
    :return         The total amount of unique answers
    """
    answers_split = [char for char in answers if char in ascii_lowercase]
    return len(set(answers_split))
